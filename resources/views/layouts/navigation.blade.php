<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @endcan
                    @can('solicitations index')
                        <x-nav-link :href="route('solicitations.index')" :active="request()->routeIs('solicitations/*')">
                            {{ __('Solicitations') }}
                        </x-nav-link>
                    @endcan
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endcan
            @can('solicitations index')
                <x-responsive-nav-link :href="route('solicitations.index')" :active="request()->routeIs('solicitations/*')">
                    {{ __('Solicitations') }}
                </x-responsive-nav-link>
            @endcan
        </div>
